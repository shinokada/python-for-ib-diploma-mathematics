...
Exploring Normal Distribution with Jupyter Notebook<br>Beginners Guide to Normal Distribution|<ul><li>[nbviewer](https://nbviewer.jupyter.org/github/shinokada/python-for-ib-diploma-mathematics/blob/master/Normal_distribution.ipynb)</ul>
